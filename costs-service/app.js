...
// Initialize Express app, logger, and shared constants
const app = express();
...
// Build the error shape required by the project document
...
app.post('/api/add', async (req, res) => {
    try {
        ...
        // Validate that the category is one of the five allowed project categories
        ...
        logger.error(err, 'failed to add cost');
...
// Normalize legacy category name 'sport' to the required 'sports'
...
/*
  ...
  instead of recalculating it from the costs collection.
*/
...
// Export the app so unit tests can call the endpoints directly
module.exports = app;
